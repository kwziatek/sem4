...
with open('outputex2.txt', 'r') as f:
    for line in f:
...
plt.title('Wykres zamian i porównań w select', fontsize=14)
...
plt.savefig('select_chart', dpi=300)
print("Wykres został zapisany jako 'select_chart'")