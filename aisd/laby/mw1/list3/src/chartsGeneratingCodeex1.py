...
with open('outputex1.txt', 'r') as f:
    for line in f:
...
plt.title('Wykres zamian i porównań w randomized select', fontsize=14)
...
plt.savefig('randomized_select_chart', dpi=300)
print("Wykres został zapisany jako 'randomized_select_chart'")